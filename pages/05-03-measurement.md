...
측정을 20000번만 했으니 평균값이 기댓값과 조금 다르게 나오지만 측정 횟수를 더 크게 할 수록 점점 더 가까워질 것입니다. 확률론에서 배웠던 것처럼요.
...
**평균은 0인데 제곱의 평균은 0이 아니다.** 이 차이가 중요합니다. 흔들림의 크기를 재려면 $\langle p\rangle$이 아니라 $\langle p^2\rangle - \langle p\rangle^2$을 봐야 하거든요.
...
$\langle p\rangle = 0$인데 $\langle p^2\rangle \neq 0$이라는 것이 무슨 뜻일까요? 흔들리고 있다는 뜻입니다. 다음 절에서 그 흔들림의 크기를 재고, 2.4절에서 만났던 불확정성 원리를 연산자의 언어로 다시 만나겠습니다.
